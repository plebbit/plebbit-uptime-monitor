...
const plebbitPubsubApi = await Plebbit({
  ...config.plebbitOptions,
  ipfsHttpClientsOptions: [pubsubApiUrl],
  pubsubHttpClientsOptions: [pubsubApiUrl]
})
...
export {kubo, kuboPubsub, plebbitIpfsApi, plebbitPubsubApi, plebbit, kuboPubsubProviders}
