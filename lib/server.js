...
import {getPlebbitPeerCounts} from './plebbit.js' // must import ./plebbit to register plebbit prometheus metrics
...
app.get('/', (req, res) => {
  ...
  const plebbit = {subplebbitsStats: {}, subplebbitCount: 0, ...getPlebbitPeerCounts()}
  const subplebbits = {}
