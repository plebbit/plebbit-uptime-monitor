...
app.get('/', (req, res) => {
  ...
  for (const {address: subplebbitAddress} of monitorState.subplebbitsMonitoring) {
    subplebbits[subplebbitAddress] = {
      ...
      ipnsName: monitorState.subplebbits[subplebbitAddress].ipnsName,
      ...
      pubsubTopicRoutingCid: monitorState.subplebbits[subplebbitAddress].pubsubTopicRoutingCid,
      ipnsPubsubTopic: monitorState.subplebbits[subplebbitAddress].ipnsPubsubTopic,
      ipnsPubsubTopicRoutingCid: monitorState.subplebbits[subplebbitAddress].ipnsPubsubTopicRoutingCid,
      // ipns
      ...
      // pubsub
      pubsubDhtPeerCount: monitorState.subplebbits[subplebbitAddress].pubsubDhtPeers?.length,
      pubsubHttpRoutersPeerCount: monitorState.subplebbits[subplebbitAddress].pubsubHttpRoutersPeers?.length,
      pubsubPeerCount: monitorState.subplebbits[subplebbitAddress].pubsubPeers?.length,
  ...
  const jsonResponse = {subplebbits, ipfsGateways, pubsubProviders, httpRouters, plebbitSeeders, plebbitPreviewers, chainProviders, webpages, nfts, plebbit}
