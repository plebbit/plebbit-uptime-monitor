...
export const ipnsNameToLibp2pFetchKey = (ipnsName) => {
  // for ipns over pubsub, the libp2p fetch key is '/ipns/' + ASCII(Uint8Array('12D...'))
  // https://github.com/ipfs/boxo/blob/85fbc3a6c585f779dadade672470dabe0f9c7757/namesys/ipns_publisher.go#L59
  const ipnsNameBytes = PeerId.parse(ipnsName).toBytes() // accepts base58 (12D...) and base36 (k51...)
