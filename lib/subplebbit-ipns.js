  ...
  for (const subplebbit of monitorState.subplebbitsMonitoring) {
    ...
    ;(async () => {
      try {
        ...
        const ipnsOverPubsubTopic = ipnsNameToIpnsOverPubsubTopic(getPlebbitAddressFromPublicKey(subplebbitUpdate.signature.publicKey))
        ...
        monitorState.subplebbits[subplebbit.address] = {...monitorState.subplebbits[subplebbit.address], ipnsOverPubsubTopic, ipnsPeersCid}
